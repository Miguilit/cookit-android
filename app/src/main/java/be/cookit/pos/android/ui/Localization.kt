...
data class UiStrings(
    ...
    val optionsAvailable: String,
    val chooseOptions: String,
    val requiredOption: String,
    val modifierRequired: String,
    val included: String,
    val confirmOptions: String,
    val optionsLoadFailed: String,
    val totalUpdated: String,
    ...
    val cashRoundedTotal: String,
    val cashRounding: String,
...
fun strings(language: AppLanguage): UiStrings = when (language) {
    AppLanguage.FR -> UiStrings(
        ...
        emptyCart="Panier vide", optionsAvailable="Options", chooseOptions="Choisir les options", requiredOption="Obligatoire",
        modifierRequired="Sélectionnez une option dans chaque groupe obligatoire.", included="Inclus", confirmOptions="Ajouter au panier",
        optionsLoadFailed="Impossible de charger les options. Réessayez.", totalUpdated="Le total a été recalculé par Cookit. Vérifiez le nouveau montant avant de confirmer le paiement.", chooseTable="Table", cashOpening="Ouverture de caisse",
        ...
        cashRoundedTotal="Total espèces arrondi", cashRounding="Arrondi espèces", amountReceived="Montant reçu", changeDue="Monnaie à rendre",
    ...
    AppLanguage.NL -> UiStrings(
        ...
        emptyCart="Winkelmand leeg", optionsAvailable="Opties", chooseOptions="Kies opties", requiredOption="Verplicht",
        modifierRequired="Kies een optie in elke verplichte groep.", included="Inbegrepen", confirmOptions="Toevoegen aan winkelmand",
        optionsLoadFailed="Opties konden niet worden geladen. Probeer opnieuw.", totalUpdated="Cookit heeft het totaal opnieuw berekend. Controleer het nieuwe bedrag voordat u de betaling bevestigt.", chooseTable="Tafel", cashOpening="Kassa openen",
        ...
        cashRoundedTotal="Afgerond contant totaal", cashRounding="Contante afronding", amountReceived="Ontvangen bedrag", changeDue="Wisselgeld",
    ...
    AppLanguage.EN -> UiStrings(
        ...
        emptyCart="Cart is empty", optionsAvailable="Options", chooseOptions="Choose options", requiredOption="Required",
        modifierRequired="Select an option in every required group.", included="Included", confirmOptions="Add to cart",
        optionsLoadFailed="Options could not be loaded. Please try again.", totalUpdated="Cookit recalculated the total. Check the new amount before confirming payment.", chooseTable="Table", cashOpening="Open cash register",
        ...
        cashRoundedTotal="Rounded cash total", cashRounding="Cash rounding", amountReceived="Amount received", changeDue="Change due",
    ...
    AppLanguage.DE -> UiStrings(
        ...
        emptyCart="Warenkorb leer", optionsAvailable="Optionen", chooseOptions="Optionen wählen", requiredOption="Pflicht",
        modifierRequired="Wählen Sie in jeder Pflichtgruppe eine Option.", included="Inbegriffen", confirmOptions="Zum Warenkorb hinzufügen",
        optionsLoadFailed="Optionen konnten nicht geladen werden. Bitte erneut versuchen.", totalUpdated="Cookit hat den Gesamtbetrag neu berechnet. Prüfen Sie den neuen Betrag vor der Zahlungsbestätigung.", chooseTable="Tisch", cashOpening="Kasse öffnen",
        ...
        cashRoundedTotal="Gerundeter Barbetrag", cashRounding="Bar-Rundung", amountReceived="Erhaltener Betrag", changeDue="Rückgeld",
